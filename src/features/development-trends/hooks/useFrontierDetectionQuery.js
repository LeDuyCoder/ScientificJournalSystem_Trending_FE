...
/**
 * Hook to fetch frontier detection data with TanStack Query caching.
 * @param {string|number} projectId - The project ID
 * @param {object} filters - Active dashboard filters
 * @param {number} refreshTrigger - Dashboard manual refresh trigger
 */
export const useFrontierDetectionQuery = (projectId, filters = {}, refreshTrigger) => {
  return useQuery({
    ...
    select: (response) => response?.data?.frontierDetection,
  });
};
